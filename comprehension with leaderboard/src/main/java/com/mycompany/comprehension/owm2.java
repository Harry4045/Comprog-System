 ...
 * @author ficti
 */
public class owm2 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(owm2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
